...
if (isset($_POST['btnUpdate'])) {
    $updateID = $_POST['listID'];
    $updateList = $_POST['updateList'];
    $updateQuery =   "UPDATE lists SET list = '$updateList' WHERE id = $updateID";
    ...
    <div class="container">
        <div>
            ...
            <form action="updateList.php" method="POST">
                ...
                <input type="text" name="updateList" value="<?php echo $listItem ?>">
                <input type="submit" class="btn btn-primary" name="btnUpdate" value="Update List">
                <a href="index.php" class="btn btn-success">New List</a>
            </form>
        </div>
